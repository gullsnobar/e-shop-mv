        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-blue-100/60 border border-gray-100 overflow-hidden">
          ...
          <div className="px-7 py-7">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-400 mt-0.5 font-medium">Welcome back! Enter your credentials</p>
            </div>
            ...
            <p className="text-center text-xs text-gray-400 mt-4">
              ...
              <a href="/signup" className="text-blue-600 font-bold hover:underline">Create one</a>
            </p>
